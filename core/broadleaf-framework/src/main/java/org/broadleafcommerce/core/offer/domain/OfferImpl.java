...
public class OfferImpl implements Offer, AdminMainEntity, OfferAdminPresentation {
    ...
    public boolean getApplyDiscountToSalePrice() {
        return applyToSalePrice != null && applyToSalePrice;
    }
    ...
    public Boolean getApplyToChildItems() {
        return applyToChildItems != null && applyToChildItems;
    }
    ...
    public boolean isCombinableWithOtherOffers() {
        return combinableWithOtherOffers != null && combinableWithOtherOffers;
    }
    ...
    public Boolean getRequiresRelatedTargetAndQualifiers() {
        return requiresRelatedTargetAndQualifiers != null && requiresRelatedTargetAndQualifiers;
    }
